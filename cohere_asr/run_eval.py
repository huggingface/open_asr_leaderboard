...
def main(args):
    ...
    def transcribe_records(records, collect_results) -> tuple[list[float], list[float], list[str], list[str], list[str | None]] | None:
        ...
        audio_filepaths = [record["audio_filepath"] for record in records]
        ...
        return audio_lengths, transcription_times, predictions, references, audio_filepaths
