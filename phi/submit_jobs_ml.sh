#!/bin/bash
# Local script to submit HF Jobs for multilingual Phi-4 multimodal ASR evaluation.
...
MODEL_CONFIGS=(
    "microsoft/Phi-4-multimodal-instruct      64"
)

# ── Datasets/languages: "dataset language" (comment / uncomment to select) ──
# German, French, Italian, Spanish, Portuguese, Chinese
...
for model_cfg in "${MODEL_CONFIGS[@]}"; do
    ...
    # Sanitize model ID for use as a folder name (e.g. "microsoft/Phi-4" -> "microsoft-Phi-4")
