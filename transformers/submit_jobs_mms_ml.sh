#!/bin/bash
# Local script to submit HF Jobs for multilingual MMS ASR evaluation.
...
# Usage: HF_TOKEN=hf_... bash submit_jobs_mms_ml.sh
#        HF_TOKEN=hf_... ONLY_LANGUAGES="nl" bash submit_jobs_mms_ml.sh
...
MODEL_CONFIGS=(
    "facebook/mms-1b-all 64 de fr it es pt nl hy hi"
)
