#!/bin/bash
# Local script to submit HF Jobs for CrisperWhisper ASR evaluation.
# Uses half the batch size of standard Whisper due to higher memory usage.
# Usage: HF_TOKEN=hf_... bash submit_jobs_crisper_whisper.sh
...
DATASET_CONFIGS=(
    ...
    "spgispeech test 32"
    "monsoon_en_in test 32 VoiceArena/Monsoon_en_IN_test"
)
