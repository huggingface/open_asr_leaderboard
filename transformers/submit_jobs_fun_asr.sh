#!/bin/bash
# Local script to submit HF Jobs for Fun-ASR ASR evaluation on the public sets.
# Usage: HF_TOKEN=hf_... bash submit_jobs_fun_asr.sh
...
# LibriSpeech test.clean utterances (the model card's own example uses 200).
MAX_NEW_TOKENS=256
